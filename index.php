        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="index.php?page=tambah_dokter" class="nav-link active">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="index.php?page=reservasi" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Reservasi</p>
                </a>
              </li>
          ...
          <?php if($role == "pasien"): ?>
            <li class="nav-item">
                <a href="index.php?page=tambah_reservasi" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
